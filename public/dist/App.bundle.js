...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 54.043667;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -2.488511;
  var miles = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    function renderMarkers(groupedPlaces) {
      ...
      markers.forEach(function (marker) {
        return marker.addListener("click", function () {
          renderEvents(places, this.place[0].location.coordinates[1], this.place[0].location.coordinates[0]);
...
function makeMap(mapDiv) {
  ...
  var image = "/images/icons/current_location.png";
  ...
  distance.addEventListener("change", function () {
    ...
    loadPlaces(map, place.geometry.location.lat(), place.geometry.location.lng(), miles);
  ...
  autocomplete.addListener("place_changed", function () {
    ...
    loadPlaces(map, place.geometry.location.lat(), place.geometry.location.lng(), miles, current);
  });
...
var _clearFilters = __webpack_require__(13);
